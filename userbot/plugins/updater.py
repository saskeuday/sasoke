...
OFFICIAL_UPSTREAM_REPO = "https://github.com/saskeuday/sasoke"
BOT_IS_UP_TO_DATE = "Saske userbot is up-to-date!."
NEW_BOT_UP_DATE_FOUND = (
    "**Saske Update Found For** {branch_name}\n"
    "\n\n{changelog}\n"
    "Pulling Updates !!"
)
NEW_UP_DATE_FOUND = (
...
async def deploy_start(bot, message, refspec, remote):
    ...
    await message.edit("**The Latest Branch** `Master` **Has Been Pushed To Heroku** \n**Now Trying A Restart To Complete Updation Process ⚠️ !!** To Check If I am Alive Just Do `.alive` or `.help` !!!! Thank For Using Saske Userbot Service (◍•ᴗ•◍)❤")

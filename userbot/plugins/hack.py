...
async def _(event):
    ...
    if event.reply_to_msg_id:
        ...
        if idd==367810114:
            ...
            "`Hacking... 100%\n█████████HACKED███████████ `\n\n\n  TERMINAL:\n\n **Successfully Hacked Telegram Server Database**\n\n\n🔹Output: Generating.....",
            "`Targeted Account Hacked...\n\nPay 999999999$ To My Boss ѕᴀѕᴋᴇ ʟ̤ɾʅ丂ɹɹɹȊɹɹɹ @saske_89 to Remove this hack🌝🌿....`\n\nTERMINAL:\n\n**Successfully Hacked this Account From Telegram Database**\n\n\n🔹**Output:** Successful"
